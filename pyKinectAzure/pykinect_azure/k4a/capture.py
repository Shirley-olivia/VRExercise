...
from pyKinectAzure.pykinect_azure.k4a.transformation import Transformation
from pyKinectAzure.pykinect_azure.utils.postProcessing import smooth_depth_image
...
class Capture:
	...
	def get_color_image(self):
		ret, color_image = self.get_color_image_object().to_numpy()
		if not ret:
			return ret, None
